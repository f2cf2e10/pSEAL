...
//         .def_static("BFVDefault", (std::vector<SmallModulus>(*)(std::size_t, sec_level_type)) & CoeffModulus::BFVDefault,
...
//         .def_static("Create", (std::vector<SmallModulus>(*)(std::size_t, std::vector<int>)) & CoeffModulus::Create,
...
//         .def_static("Create", (std::shared_ptr<SEALContext>(*)(const EncryptionParameters &, bool, sec_level_type)) & SEALContext::Create,
...
//              "parms_id"_a,
//              "destination"_a, "pool"_a = MemoryManager::GetPool())
//         .def("encrypt_symmetric", (void(Encryptor::*)(const Plaintext &, Ciphertext &, MemoryPoolHandle)) & Encryptor::encrypt_symmetric,
...
//         pool pointed to by the given MemoryPoolHandle.",
//              "plain"_a, "destination"_a, "pool"_a = MemoryManager::GetPool())
//         .def("encrypt_zero_symmetric", (void(Encryptor::*)(Ciphertext &, MemoryPoolHandle)) & Encryptor::encrypt_symmetric,
...
//         .def("encrypt_zero_symmetric", (void(Encryptor::*)(parms_id_type, Ciphertext &, MemoryPoolHandle)) & Encryptor::encrypt_symmetric,
//              "Encrypts a zero plaintext with the secret key and stores the result in \
//         destination. The encryption parameters for the resulting ciphertext \
//         correspond to the given parms_id. Dynamic memory allocations in the process \
//         are allocated from the memory pool pointed to by the given MemoryPoolHandle.",
...
//         .def("relinearize", (void(Evaluator::*)(const Ciphertext &, const RelinKeys &, const Ciphertext &, MemoryPoolHandle)) & Evaluator::relinearize,
//              "Relinearizes a ciphertext. This functions relinearizes encrypted, reducing \
...
//         .def("multiply_many", (void(Evaluator::*)(const std::vector<Ciphertext> &, const RelinKeys &, Ciphertext &, MemoryPoolHandle)) & Evaluator::multiply_many,
//              "",
...
//         .def("transform_to_ntt", (void(Evaluator::*)(const Plaintext &, parms_id_type, Plaintext &, MemoryPoolHandle)) & Evaluator::multiply_plain,
//              "",
...
//              "",
//              "encrypted"_a, "galois_keys"_a, "pool"_a = MemoryManager::GetPool())
//         .def("complex_conjugate", (void(Evaluator::*)(const Ciphertext &, int, const GaloisKeys &, Ciphertext &, MemoryPoolHandle)) & Evaluator::complex_conjugate,
//              "",
//              "encrypted"_a, "steps"_a, "galois_keys"_a, "destination"_a, "pool"_a = MemoryManager::GetPool());
//     /*****************************************************/
...
//         .def("decode", (void(BatchEncoder::*)(const Plaintext &, std::vector<uint64_t> &, MemoryPoolHandle)) & BatchEncoder::decode,
...
//              "plain"_a, "destination"_a, "pool"_a = MemoryManager::GetPool())
//         .def("decode", (void(BatchEncoder::*)(const Plaintext &, std::vector<int64_t> &, MemoryPoolHandle)) & BatchEncoder::decode,
//              "Inverse of encode. This function 'unbatches' a given plaintext into a matrix \
//         of integers modulo the plaintext modulus, and stores the result in the destination \
//         parameter. The input plaintext must have degress less than the polynomial modulus, \
//         and coefficients less than the plaintext modulus, i.e. it must be a valid plaintext \
